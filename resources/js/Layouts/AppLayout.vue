    ...
    <template>
        <div>
            ...
            <div class="min-h-screen bg-gray-50">
                <nav class="bg-gradient-to-r from-blue-800 to-blue-600 border-b border-blue-700 shadow-lg">
                            ...
                            <div class="flex">
                                ...
                                <div class="shrink-0 flex items-center">
                                    <Link :href="route('dashboard')">
                                        <h1 class="text-white text-xl font-bold tracking-wide">Prueba Técnica Cotecmar AMCE</h1>
                                    </Link>
                                </div>

                                <!-- Navigation Links -->
                                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                    <NavLink :href="route('dashboard')" :active="route().current('dashboard')" class="text-white hover:text-blue-100 transition duration-150 ease-in-out">
                                        Dashboard
                                    </NavLink>
